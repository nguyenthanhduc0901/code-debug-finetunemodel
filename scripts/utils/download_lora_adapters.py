...
def main():
    ...
    parser.add_argument(
        "--model", 
        type=str, 
        choices=["all", "gemma4_lora", "qwen_coder_lora", "qwen_socratic_lora"], 
        default="all",
        help="Specific LoRA model to download (default: all)"
    )
    parser.add_argument(
        "--token",
        type=str,
        default=os.environ.get("HF_TOKEN"),
        help="Hugging Face access token (required for private repositories)"
    )
